...
def RangeTrendCSV():
    ...
    st1 = ts.strategies.RangeTrade(client, range_process=rtp_p, data_length=30, interval_mins=0, alpha=2, slope_ratio=0.1, logger=logger)
...
def RangeTrendMT5Simulation(frame):
    ...
    st1 = ts.strategies.RangeTrade(client, range_process=rtp_p, data_length=30,interval_mins=-1, logger=logger)
